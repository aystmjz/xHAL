...
#define XADC_CHANNEL_1        ((uint16_t)(1U << 0))  /* 通道 1 */
#define XADC_CHANNEL_2        ((uint16_t)(1U << 1))  /* 通道 2 */
#define XADC_CHANNEL_3        ((uint16_t)(1U << 2))  /* 通道 3 */
#define XADC_CHANNEL_4        ((uint16_t)(1U << 3))  /* 通道 4 */
#define XADC_CHANNEL_5        ((uint16_t)(1U << 4))  /* 通道 5 */
#define XADC_CHANNEL_6        ((uint16_t)(1U << 5))  /* 通道 6 */
#define XADC_CHANNEL_7        ((uint16_t)(1U << 6))  /* 通道 7 */
#define XADC_CHANNEL_8        ((uint16_t)(1U << 7))  /* 通道 8 */
#define XADC_CHANNEL_9        ((uint16_t)(1U << 8))  /* 通道 9 */
#define XADC_CHANNEL_10       ((uint16_t)(1U << 9))  /* 通道 10 */
#define XADC_CHANNEL_11       ((uint16_t)(1U << 10)) /* 通道 11 */
#define XADC_CHANNEL_12       ((uint16_t)(1U << 11)) /* 通道 12 */
#define XADC_CHANNEL_13       ((uint16_t)(1U << 12)) /* 通道 13 */
#define XADC_CHANNEL_14       ((uint16_t)(1U << 13)) /* 通道 14 */
#define XADC_CHANNEL_15       ((uint16_t)(1U << 14)) /* 通道 15 */
#define XADC_CHANNEL_16       ((uint16_t)(1U << 15)) /* 通道 16 */

enum xhal_adc_resolution
{
    XADC_RESOLUTION_8BIT = 8,
    XADC_RESOLUTION_10BIT,
    XADC_RESOLUTION_12BIT,
    XADC_RESOLUTION_14BIT,
    XADC_RESOLUTION_16BIT,
};
...
typedef struct xhal_adc_ops
{
    ...
    uint32_t (*read_sample)(xhal_adc_t *self, uint32_t samples,
                            uint8_t channel_mask, uint16_t **buffers);
