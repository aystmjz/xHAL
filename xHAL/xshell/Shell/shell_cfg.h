 ...
 */
#define SHELL_PARAMETER_MAX_NUMBER  6

/**
 * @brief 历史命令记录数量
 */
#define SHELL_HISTORY_MAX_NUMBER    6
 ...
 */
#define SHELL_GET_TICK()            xtime_get_tick_ms()
 ...
 * @brief shell默认用户
 */
#define SHELL_DEFAULT_USER          XSHELL_DEFAULT_USER

/**
 * @brief shell默认用户密码
 *        若默认用户不需要密码，设为""
 */
#define SHELL_DEFAULT_USER_PASSWORD XSHELL_DEFAULT_USER_PASSWORD
