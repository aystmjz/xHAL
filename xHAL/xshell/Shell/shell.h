...
#define SHELL_AGENCY_FUNC(_func, ...)                                          \
    void SHELL_AGENCY_FUNC_NAME(_func)(int p1, int p2, int p3, int p4, int p5, \
                                       int p6, int p7)                         \
    {                                                                          \
        _func(__VA_ARGS__);                                                    \
    }
    ...
    #define SHELL_EXPORT_CMD(_attr, _name, _func, _desc, ...)            \
        ...
        SHELL_USED const ShellCommand shellCommand##_name SHELL_SECTION( \
            "shellCommand") = {.attr.value        = _attr,               \
    ...
    #define SHELL_EXPORT_VAR(_attr, _name, _value, _desc)            \
        const char shellCmd##_name[]  = #_name;                      \
        const char shellDesc##_name[] = #_desc;                      \
        SHELL_USED const ShellCommand shellVar##_name SHELL_SECTION( \
            "shellCommand") = {.attr.value     = _attr,              \
    ...
    #define SHELL_EXPORT_USER(_attr, _name, _password, _desc)               \
        ...
        const char shellDesc##_name[]     = #_desc;                         \
        SHELL_USED const ShellCommand shellUser##_name SHELL_SECTION(       \
            "shellCommand") = {.attr.value =                                \
    ...
    #define SHELL_EXPORT_KEY(_attr, _value, _func, _desc)                     \
        ...
        SHELL_USED const ShellCommand shellKey##_value SHELL_SECTION(         \
            "shellCommand") = {.attr.value =                                  \
    ...
    #define SHELL_EXPORT_KEY_AGENCY(_attr, _value, _func, _desc, ...) \
        ...
        #define SHELL_EXPORT_PARAM_PARSER(_attr, _type, _parser, _cleaner)     \
            ...
            SHELL_USED const ShellCommand shellCommand##_parser SHELL_SECTION( \
                "shellCommand") = {                                            \
